class ClientUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @client_user.save
        format.html { redirect_to @client_user, notice: 'Relacion cliente usuario creada exitosamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @client_user.update_attributes(params[:client_user])
        format.html { redirect_to @client_user, notice: 'Relacion cliente usuario actualizada exitosamente.' }
